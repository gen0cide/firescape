    ...
    while (flag19) {
      ...
      for (int k5 = ai2[l7 - ai1[i7]]; k5 != l4;)
        if (k5 == 0 || k5 == 1) {
          ...
          j6++;
          byte byte5 = dataFileVariables.aByteArray493[dataFileVariables.aByteArray494[dataFileVariables.anIntArray495[0]]
              & 0xff];
          ...
          if (j11 < 16) {
            ...
            for (; l10 > 0; l10--) {
              dataFileVariables.anIntArray495[l10]--;
              dataFileVariables.aByteArray494[dataFileVariables.anIntArray495[l10]] = dataFileVariables.aByteArray494[(dataFileVariables.anIntArray495[l10
                  - 1] + 16) - 1];
            }
