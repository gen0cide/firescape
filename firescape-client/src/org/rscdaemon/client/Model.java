...
public class Model {
  ...
  private void method192() {
    if (anInt295 != 256 || anInt296 != 256 || anInt297 != 256 || anInt298 != 256 || anInt299 != 256
        || anInt300 != 256) {
      anInt301 = 4;
      return;
    }
  ...
  public void method198() {
    ...
    for (int j = 0; j < anInt234; j++)
      if (anIntArray241[j] != anInt270)
        anIntArray241[j] = (anIntArray242[j] * anInt303 + anIntArray243[j] * anInt304 + anIntArray244[j] * anInt305)
            / i;
  ...
  public void method199() {
    ...
    for (int i = 0; i < anInt234; i++) {
      ...
      int l2 = k1 * l1 - j2 * i1;
      int i3;
      for (i3 = i1 * i2 - l1 * j1; k2 > 8192 || l2 > 8192 || i3 > 8192 || k2 < -8192 || l2 < -8192
          || i3 < -8192; i3 >>= 1) {
        k2 >>= 1;
        l2 >>= 1;
      }
  ...
  public void method201(int i, int j, int k, int l, int i1, int j1, int k1, int l1) {
    method200();
    if (anInt252 > Camera.anInt453 || anInt253 < Camera.anInt452 || anInt248 > Camera.anInt449
        || anInt249 < Camera.anInt448 || anInt250 > Camera.anInt451 || anInt251 < Camera.anInt450) {
      aBoolean247 = false;
      return;
    }
    aBoolean247 = true;
