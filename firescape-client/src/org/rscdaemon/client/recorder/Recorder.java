...
public class Recorder implements Runnable, ControllerListener, DataSinkListener {
  ...
  public Recorder(int width, int height, float frameRate, LinkedList<BufferedImage> frames, String output,
      String format) {
    this.width = width;
    this.height = height;
    this.frames = frames;
  ...
  public void controllerUpdate(ControllerEvent e) {
    if ((e instanceof ConfigureCompleteEvent) || (e instanceof RealizeCompleteEvent)
