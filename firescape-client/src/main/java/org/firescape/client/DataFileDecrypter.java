  ...
  private static void method131(DataFileVariables dataFileVariables) {
    ...
    while (flag19) {
      ...
      for (int l3 = 0; l3 < j4; l3++) {
        ...
        method136(dataFileVariables.anIntArrayArray499[l3], dataFileVariables.anIntArrayArray500[l3],
                dataFileVariables.anIntArrayArray501[l3], dataFileVariables.aByteArrayArray498[l3], byte8, i, i4);
      ...
      for (int k5 = ai2[l7 - ai1[i7]]; k5 != l4; )
        if (k5 == 0 || k5 == 1) {
          ...
          j6++;
          byte byte5 =
                  dataFileVariables.aByteArray493[dataFileVariables.aByteArray494[dataFileVariables.anIntArray495[0]]
                          & 0xff];
          ...
          if (j11 < 16) {
            ...
            for (; l10 > 0; l10--) {
              dataFileVariables.anIntArray495[l10]--;
              dataFileVariables.aByteArray494[dataFileVariables.anIntArray495[l10]] =
                      dataFileVariables.aByteArray494[(dataFileVariables.anIntArray495[l10
                              - 1] + 16) - 1];
            }
            ...
            if (dataFileVariables.anIntArray495[0] == 0) {
              ...
              for (int k9 = 15; k9 >= 0; k9--) {
                for (int l9 = 15; l9 >= 0; l9--) {
                  dataFileVariables.aByteArray494[i10] =
                          dataFileVariables.aByteArray494[dataFileVariables.anIntArray495[k9]
                                  + l9];
                  i10--;
                }
  ...
  private static int method134(int i, DataFileVariables dataFileVariables) {
    ...
    do {
      ...
      dataFileVariables.anInt478 = dataFileVariables.anInt478 << 8
              | dataFileVariables.aByteArray465[dataFileVariables.anInt466] & 0xff;
