...
public class GameImage implements ImageProducer, ImageObserver {
  ...
  public Sprite[] sprites;  public synchronized void addConsumer(ImageConsumer imageconsumer) {
  ...
  public int menuDefaultWidth;  public synchronized boolean isConsumer(ImageConsumer imageconsumer) {
    return imageConsumer == imageconsumer;
  }
  public int menuDefaultHeight;  public synchronized void removeConsumer(ImageConsumer imageconsumer) {
    if (imageConsumer == imageconsumer) {
      imageConsumer = null;
    }
  }
  public int imageWidthUnused;  public void startProduction(ImageConsumer imageconsumer) {
    addConsumer(imageconsumer);
  }
  public int imageHeightUnused;  public void requestTopDownLeftRightResend(ImageConsumer imageconsumer) {
