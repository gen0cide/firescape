...
import org.firescape.client.entityhandling.EntityHandler;
import org.firescape.client.entityhandling.defs.ItemDef;
import org.firescape.client.entityhandling.defs.NPCDef;
import org.firescape.client.model.Sprite;
import org.firescape.client.recorder.Recorder;
import org.firescape.client.util.Config;
import org.firescape.client.util.DataConversions;
...
public final class mudclient extends GameWindowMiddleMan {
  ...
  public static String Clientname = "FireScape";
  ...
  protected final void method4() {
    if (lastLoadedNull) {
      ...
      int i = 35;
      g.drawString("Sorry, an error has occured whilst loading FireScape", 30, i);
      i += 50;
    ...
    if (memoryError) {
      ...
      g2.drawString("FireScape needs about 100mb of spare RAM", 50, 200);
      changeThreadSleepModifier(1);
      return;
    }
    try {
  ...
  private final void drawWelcomeBox() {
    ...
    j += 20;
    gameGraphics.drawText("Welcome to FireScape " + currentUser, 256, j, 4, 0xffff00);
    j += 30;
    String s;
  ...
  private final void makeLoginMenus() {
    ...
    int i = 40;
    menuWelcome.drawText(256, 200 + i, "Welcome to FireScape", 4, true);
    menuWelcome.drawText(256, 215 + i, "-alexlevinson", 4, true);
  ...
  protected final void handleMenuKeyDown(int key) {
    switch (key) {
      ...
      case 1013: // F6
        showInfo = !showInfo;
        if (showInfo) {
          handleServerMessage("@whi@[@cya@FireScape@whi@] @whi@Showing Info:@gre@ On");
        } else {
          handleServerMessage("@whi@[@cya@FireScape@whi@] @whi@Showing Info:@red@ Off");
        }
        break;
      case 1018: // F11
        recording = !recording;
