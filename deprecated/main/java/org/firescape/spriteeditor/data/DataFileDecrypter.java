  ...
  private static void method131(DataFileVariables dataFileVariables) {
    ...
    while (flag19) {
      ...
      for (int l3 = 0; l3 < j4; l3++) {
        ...
        method136(
          dataFileVariables.anIntArrayArray499[l3],
          dataFileVariables.anIntArrayArray500[l3],
          dataFileVariables.anIntArrayArray501[l3],
          dataFileVariables.aByteArrayArray498[l3],
          byte8,
          i,
          i4
        );
      ...
      for (int k5 = ai2[l7 - ai1[i7]]; k5 != l4; ) {
        if (k5 == 0 || k5 == 1) {
          ...
          if (j11 < 16) {
            ...
            for (; l10 > 0; l10--) {
              dataFileVariables.anIntArray495[l10]--;
              dataFileVariables.aByteArray494[dataFileVariables.anIntArray495[l10]] = dataFileVariables.aByteArray494[(dataFileVariables.anIntArray495[
                                                                                                                         l10 -
                                                                                                                         1] +
                                                                                                                       16) -
                                                                                                                      1];
