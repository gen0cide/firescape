package org.firescape.spriteeditor.entityhandling;

import org.firescape.spriteeditor.entityhandling.defs.ItemDef;
import org.firescape.spriteeditor.entityhandling.defs.NPCDef;
import org.firescape.spriteeditor.entityhandling.defs.extras.AnimationDef;
import org.firescape.spriteeditor.entityhandling.defs.extras.TextureDef;
import org.firescape.spriteeditor.util.PersistenceManager;

import java.io.File;

/**
 * This class handles the loading of entities from the def files, and provides methods for relaying these entities to
 * the application.
 */
