 ...
 * <p>
 * WARNING: * packageName, id, xShift, yShift, width2, height2 * are lost when loading from img. packageName doesn't *
...
public class Sprite {
  ...
  /**
   * This is not a fully-understood variable, but it seems to usually represent the variable 'width's value
   */
  private int width2 = 0;
  /**
   * This is not a fully-understood variable, but it seems to usually represent the variable 'height's value
   */
