                    ...
                    DelayedEvent.world.getDelayedEventHandler().add(new ShortEvent(owner) {
                      public void action() {
                        ...
                        if (number == 0) {
                          ...
                          player.getInventory().add(new InvItem(400, 1));// Rune
                          // Chain
                        ...
                        if (number == 1) {
                          player.getInventory().remove(10, 100000);
                          player.getInventory().add(new InvItem(1155, 1));// Old
                          // Boot!
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 3) {
                          player.getInventory().remove(10, 100000);
                          player.getInventory().add(new InvItem(75, 1));// Rune
                          // Longsword
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 5) {
                          player.getInventory().remove(10, 100000);
                          player.getInventory().add(new InvItem(112, 1));// Rune
                          // Large
                          // Helmet
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 11) {
                          player.getInventory().remove(10, 100000);
                          player.getInventory().add(new InvItem(525, 1));// Crystal
                          // Key
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 13) {
                          player.getInventory().remove(10, 100000);
                          player.getInventory().add(new InvItem(402, 1));// Rune
                          // Legs
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 15) {
                          player.getInventory().remove(10, 100000);
                          player.getInventory().add(new InvItem(518, 20));// Coal
                          // Certs
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 18) {
                          player.getInventory().remove(10, 100000);
                          player.getInventory().add(new InvItem(81, 1));// Rune
                          // 2-Handed
                          // Sword
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 21) {
                          player.getInventory().remove(10, 100000);
                          player.getInventory().add(new InvItem(401, 1));// Rune
                          // Plate
                          player.getActionSender().sendInventory();
                    ...
                    DelayedEvent.world.getDelayedEventHandler().add(new ShortEvent(owner) {
                      public void action() {
                        ...
                        if (number == 0) {
                          ...
                          player.getInventory().add(new InvItem(1378, 30));// Range
                          // Exp
                          // Certs
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 2) {
                          player.getInventory().remove(10, 500000);
                          player.getInventory().add(new InvItem(1363, 1));// Rune
                          // Rune
                          // Plate(m)
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 10) {
                          player.getInventory().remove(10, 500000);
                          player.getInventory().add(new InvItem(597, 1));// Dragonstone
                          // Amulet
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 11) {
                          player.getInventory().remove(10, 500000);
                          player.getInventory().add(new InvItem(518, 80));// Coal
                          // Certs
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 15) {
                          player.getInventory().remove(10, 500000);
                          player.getInventory().add(new InvItem(1373, 40));// Attack
                          // Exp
                          // Certs
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 19) {
                          player.getInventory().remove(10, 500000);
                          player.getInventory().add(new InvItem(593, 1));// Dragon
                          // Long
                          player.getActionSender().sendInventory();
                  ...
                  if (player.getInventory().countId(10) > 999999) {
                    ...
                    DelayedEvent.world.getDelayedEventHandler().add(new ShortEvent(owner) {
                      public void action() {
                        ...
                        if (number == 5) {
                          player.getInventory().remove(10, 1000000);
                          player.getInventory().add(new InvItem(594, 1));// Dragon
                          // Axe
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 11) {
                          player.getInventory().remove(10, 1000000);
                          player.getInventory().add(new InvItem(1374, 100));// Defense
                          // Exp
                          // Certs
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 13) {
                          player.getInventory().remove(10, 1000000);
                          player.getInventory().add(new InvItem(518, 200));// Coal
                          // Certs
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 15) {
                          player.getInventory().remove(10, 1000000);
                          player.getInventory().add(new InvItem(1270, 25));// Dragon
                          // Bone
                          // Certs
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 17) {
                          player.getInventory().remove(10, 1000000);
                          player.getInventory().add(new InvItem(1310, 100));// Magic
                          // Logs
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 19) {
                          player.getInventory().remove(10, 1000000);
                          player.getInventory().add(new InvItem(31, 5000));// Fire
                          // Rune
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 21) {
                          player.getInventory().remove(10, 1000000);
                          player.getInventory().add(new InvItem(33, 5000));// Air
                          // Rune
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 25) {
                          player.getInventory().remove(10, 1000000);
                          player.getInventory().add(new InvItem(1366, 1));// Party
                          // Hat
                          player.getActionSender().sendInventory();
                        ...
                        if (number == 28) {
                          player.getInventory().remove(10, 1000000);
                          player.getInventory().add(new InvItem(10, 750000));// 750,000
                          // Cions
                          player.getActionSender().sendInventory();
