...
public class PersistenceManager {
  ...
  public static void setupAliases() {
    try {
      ...
      InputStream fis = PersistenceManager.class.getResourceAsStream("/org/firescape/server/conf/server/aliases.xml");
  ...
  public static Object load(String filename) {
    try {
      InputStream is = PersistenceManager.class.getResourceAsStream("/org/firescape/server/conf/server/" + filename);
