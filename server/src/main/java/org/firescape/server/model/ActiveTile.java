...
public class ActiveTile {
  ...
  public void add(Entity entity) {
    if (entity instanceof Player) {
      ...
      /*
       * else { GameObject go = (GameObject)entity; System.out.println(
       * "  <GameObjectLoc>"); System.out.println("    <id>" +
       * go.getLoc().getId() + "</id>"); System.out.println("    <x>" +
       * go.getLoc().getX() + "</x>"); System.out.println("    <y>" +
       * go.getLoc().getY() + "</y>"); System.out.println("    <direction>" +
       * go.getLoc().getDirection() + "</direction>"); System.out.println(
       * "    <type>" + go.getLoc().getType() + "</type>"); System.out.println(
       * "  </GameObjectLoc>"); }
       */
