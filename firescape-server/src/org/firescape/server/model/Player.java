...
public final class Player extends Mob {
  ...
  public void load(String username, String password, int uid, boolean reconnecting) {
    try {
      ...
      org.firescape.server.packetbuilder.client.MiscPacketBuilder sender = getActionSender();
      ...
      sender.sendMessage("@yel@Powered by: @whi@" + "FireScape Emulator v" + (double) GameVars.projectVersion);
      sender.sendMessage(
