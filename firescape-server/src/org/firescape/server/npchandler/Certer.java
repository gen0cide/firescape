                        ...
                        public void handleReply(int certAmount, String reply) {
                          ...
                          if (certAmount == 5) {
                            ...
                            if (owner.getInventory().remove(new InvItem(certID, certAmount)) > -1) {
                              owner.getActionSender()
                                  .sendMessage("You exchange the certificates, " + bankItem.getAmount() + " "
                                      + bankItem.getDef().getName() + " is added to your bank");
                        ...
                        public void handleReply(int certAmount, String reply) {
                          ...
                          if (certAmount == 5) {
                            ...
                            if (owner.getBank().remove(itemID, itemAmount) > -1) {
                              owner.getActionSender()
                                  .sendMessage("You exchange the " + certerDef.getType() + ", " + itemAmount + " "
                                      + EntityHandler.getItemDef(itemID).getName() + " is taken from your bank");
