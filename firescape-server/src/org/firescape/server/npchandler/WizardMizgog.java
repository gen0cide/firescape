...
public class WizardMizgog implements NpcHandler {
  ...
  public void handleNpc(final Npc npc, final Player player) throws Exception {
    ...
    if (player.getImpCatcherStatus() == 1) {
            ...
            public void handleReply(final int option, final String reply) {
              ...
              world.getDelayedEventHandler().add(new ShortEvent(player) {
                public void action() {
                  ...
                  if (option == 0 && player.getInventory().countId(231) >= 1 && player.getInventory().countId(232) >= 1
                      && player.getInventory().countId(233) >= 1 && player.getInventory().countId(234) >= 1) {
                    player.informOfNpcMessage(
                        new ChatMessage(npc, "Thank you! Please take this as a reward for your help!", player));
                    ...
                    owner.getInventory().add(new InvItem(235, 1)); // Amulet of
                                                                   // Accuracy
                    ...
                    owner.getActionSender()
                        .sendMessage("@gre@Congratulations! You have just completed the: @or1@Imp Catcher @gre@quest!");
                    ...
                    player.informOfNpcMessage(
                        new ChatMessage(npc, "It appears you don't have all my beads yet!", player));
                }
              });
            }
          });
      ...
      player.informOfNpcMessage(
          new ChatMessage(npc, "The imps have stolen my beads! Please find and return them!", player));
      player.setBusy(true);
      world.getDelayedEventHandler().add(new ShortEvent(player) {
        public void action() {
          owner.setBusy(false);
                ...
                public void action() {
                  ...
                  if (option == 0) {
                    owner.informOfNpcMessage(
                        new ChatMessage(npc, "Thank you. I really appreciate you taking the time to help me!", owner));
                    world.getDelayedEventHandler().add(new ShortEvent(owner) {
                      public void action() {
                        ...
                        world.getDelayedEventHandler().add(new ShortEvent(owner) {
                          public void action() {
                            owner.informOfNpcMessage(
                                new ChatMessage(npc, "The colors are: red, white, yellow and black!", owner));
