...
public class Config {
  ...
  public static void initConfig(String file) throws IOException {
     ...
     * SERVER_NAME = props.getProperty("name"); SERVER_IP =
     * props.getProperty("ip"); SERVER_PORT =
     * Integer.parseInt(props.getProperty("port")); SERVER_LOCATION =
     * props.getProperty("location"); MAX_PLAYERS =
     * Integer.parseInt(props.getProperty("maxplayers")); LS_IP =
     * props.getProperty("lsip"); LS_PORT =
     * Integer.parseInt(props.getProperty("lsport")); LS_PASSWORD =
     * props.getProperty("lspass"); SERVER_NUM =
     * Integer.parseInt(props.getProperty("servernum"));
     */
