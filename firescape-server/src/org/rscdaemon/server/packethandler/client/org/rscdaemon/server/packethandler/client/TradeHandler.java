  ...
  public void handlePacket(Packet p, IoSession session) throws Exception {
    ...
    case 166: // Sending trade request
      ...
      if ((affectedPlayer.getPrivacySetting(2) && !affectedPlayer
          .isFriendsWith(org.rscdaemon.server.util.DataConversions.hashToUsername(player.getUsernameHash())))
          || affectedPlayer
              .isIgnoring(org.rscdaemon.server.util.DataConversions.hashToUsername(player.getUsernameHash()))) {
