...
public class GUI extends JPanel {
  ...
  private void initComponents() {
    ...
    label6.setText("FireScape v" + (double) GameVars.projectVersion);
    ...
    label11.setText("FireScape Created by xEnt");
    label11.setFont(new Font("Tahoma", Font.BOLD, 16));

    label12.setText("to Report Bugs or Suggestion, visit Moparscape in the FireScape Topic: ");
    ...
    JFrame frame = new JFrame("FireScape v" + (double) GameVars.projectVersion + " Control Panel");
