...
public class Apothecary implements NpcHandler {
  ...
  public void handleNpc(final Npc npc, Player player) throws Exception {
    player.informOfNpcMessage(
            new ChatMessage(npc, "Hello there, I am the Apothecary, What can I do for you stranger?", player));
    player.setBusy(true);
                          ...
                          public void action() {
                            ...
                            if (redEggs == null || limps == null || owner.getInventory().countId(10) < 5) {
                              owner.informOfNpcMessage(
                                      new ChatMessage(npc, "But you don't have the right ingredients.", owner));
                              running = false;
                              owner.setBusy(false);
                              npc.unblock();
