...
final class Class11 {
  ...
  static Class11 instance = new Class11(new byte[] {
    (byte) 22,
    (byte) 22,
    (byte) 22,
    (byte) 22,
  ...
  final int method240(byte[] var1, int var2, byte[] var3, int var5, int var6) {
    if (var6 == 0) {
      return 0;
    } else {
      var6 += var2;
  ...
  final int method241(int var1, int var2, byte[] var3, byte[] var4, int var6) {
    int var7 = 0;
    var2 += var1;
