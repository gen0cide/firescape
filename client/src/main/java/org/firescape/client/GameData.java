...
public class GameData {
  ...
  public static List<GameObject> gameObjectPack = new ArrayList<GameObject>();
  public static List<Prayer> prayerPack = new ArrayList<Prayer>();
  public static List<ProjectileSprite> projectileSpritePack = new ArrayList<ProjectileSprite>();
  public static List<RoofTile> roofTilePack = new ArrayList<RoofTile>();
  public static List<Spell> spellPack = new ArrayList<Spell>();
